...
SUFFIX = os.path.join(config['analysis_dir_suffix'], '')
...
ANALYSIS_DIR = os.path.join(PJ_DIR, PJ_SUFFIX)
REF_DIR = os.path.join(ANALYSIS_DIR, 'references/')
FASTQ_DIR = os.path.join(ANALYSIS_DIR, 'fastq/')
QC_DIR = os.path.join(ANALYSIS_DIR, 'fastq_qc/')
MULTI_DIR = os.path.join(QC_DIR, 'multi_species/')
BIOTYPE_DIR = os.path.join(QC_DIR, 'biotype/')
TRIM_DIR = os.path.join(ANALYSIS_DIR, 'fastq_trimmed/')
ALN_DIR = os.path.join(ANALYSIS_DIR, 'aligned/')
MD_DIR = os.path.join(ANALYSIS_DIR, 'mark_duplicates/')
ALTERED_DIR = os.path.join(ANALYSIS_DIR, 'altered_bam/')
DEEP_DIR = os.path.join(ANALYSIS_DIR, 'deeptools/')
PHANTOM_DIR = os.path.join(ANALYSIS_DIR, 'phantompeak/')
NGS_DIR = os.path.join(ANALYSIS_DIR, 'ngsplot/')
PEPR_DIR = os.path.join(ANALYSIS_DIR, 'pepr/')
HOMER_DIR = os.path.join(ANALYSIS_DIR, 'homer/')
LOG_DIR = os.path.join(ANALYSIS_DIR, 'logs/')
BENCH_DIR = os.path.join(ANALYSIS_DIR, 'benchmark/')
